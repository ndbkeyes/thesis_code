function filepath_out = mftwdfa_filepath(folder_out,data_name,mftwdfa_settings)
%
...
%
    ...
    filepath_out = sprintf("%s%s_mftwdfa_%s-%d-%d.txt",folder_out,data_name,interp_scheme,data_res,q);
