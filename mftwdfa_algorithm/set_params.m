function [filepath_in, data_subfolder, figs_subfolder, figs_compare, varnames, cutoff, t_scale, bounds_lhs, bounds_rhs] = set_params(obj)
    ...
    elseif obj.data_name == "epica-co2"
        ...
        % ----- SETTINGS FOR INPUT ----- %
        filepath_in = strcat(tag,"thesis_code\data\epica_RAW\edc3-2008_co2_DATA-series3-composite.txt");
    ...
    elseif obj.data_name == "epica-ch4"
        ...
        % ----- SETTINGS FOR INPUT ----- %
        filepath_in = strcat(tag,"thesis_code\data\epica_RAW\edc3-2008_ch4_DATA.txt");
        varnames = {'Var2','Var3'};
        cutoff = 1;
        t_scale = 1;
    ...
    elseif obj.data_name == "epica-temp"
        ...
        % ----- SETTINGS FOR INPUT: CLIMATE DATA FILE ----- %
        filepath_in = strcat(tag,"thesis_code\data\epica_RAW\aicc2012icecore-data.csv");
        varnames = {'Age','dD'};
        cutoff = 13;
        t_scale = 1;
